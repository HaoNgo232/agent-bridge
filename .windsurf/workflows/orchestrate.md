...
6. **[Agent 2]**: Finding
7. **[Agent 3]**: Finding
8. ✅ **Agent Count:** `invoked_agents >= 3`
9. ✅ **Scripts Executed:** At least `security_scan.py` ran
10. ✅ **Report Generated:** Orchestration Report with all agents listed

---

*Invoke this workflow with* `/orchestrate` *in Cascade.*
